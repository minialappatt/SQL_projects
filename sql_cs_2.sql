...
--5. LIST OUT THE FIRSTNAME, LASTNAME, SALARY, COMMISSION FOR ALL EMPLOYEES.
		...
		Select First_name as Firstname, last_name as Lastname, Salary as salary, Comm as Commission  From Employee
...
--6. LIST OUT EMPLOYEEID,LAST NAME, DEPARTMENT ID FOR ALL EMPLOYEES AND ALIAS 
    ...
    --DEPARTMENTID AS "DEP_ID".
		...
		Select emp.Employee_ID as 'ID Of Employee', emp.Last_Name as 'Name of the Employee', emp.Department_ID as Dep_ID From Employee as emp

--7. LIST OUT THE EMPLOYEES ANNUAL SALARY WITH THEIR NAMES ONLY.

		Select Salary as 'Annual Salary', CONCAT(First_name,' ',Middle_Name,' ',Last_Name) as F_name From Employee
...
--8. LIST OUT THE EMPLOYEES WHOSE NAME LENGTH IS 4 AND START WITH 'L'.
		...
		Select * From employee where len(first_name) = 4 and first_name like 'L%'

--9. LIST OUT EMPLOYEES WHO ARE WORKING IN DEPARRTMENT 30 AND DRAW THE SALARIES MORE THAN 2500.
...
--1. LIST OUT THE EMPLOYEE ID, LAST NAME IN ASCENDING ORDER BASED ON THE EMPLOYEE ID.
		...
		Select Employee_ID as ID , Last_Name as Lname From employee
...
--12. DISPLAY THE EMPLOYEE DETAILS WITH THEIR MANAGER NAMES.
		...
		Select '7902', 'OM' union all
		Select '7698', 'Akash' union all
		Select '7839', 'Raghu'
